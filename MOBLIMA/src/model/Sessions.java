...
public class Sessions implements Serializable {
     ...
     */
    private SeatPlan seatsAvailability;
     ...
     */
    public Sessions(Movie movie, LocalDateTime sessionDateTime, SeatPlan seatingPlan, int id) {
        this.movie = movie;
     ...
     */
    public SeatPlan getSeatsAvailability() {
     ...
     */
    public void setSeatsAvailability(SeatPlan seatsAvailability) {
    ...
    public LocalTime getEndTime() {
        return getStartTime().plusMinutes((long) (getMovie().getRunTime()));
    }
